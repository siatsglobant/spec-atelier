...
ActiveRecord::Schema.define(version: 2020_03_28_221426) do
  ...
  create_table "images", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["owner_type", "owner_id", "kind"], name: "index_images_on_owner_type_and_owner_id_and_kind", unique: true
